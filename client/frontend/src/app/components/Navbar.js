        ...
        <div className={`${navActive ? "active" : ""} nav__menu-list`}>
          ...
          {user && (
            <>
              ...
              >
                <NavItem active={activeIdx === MENU_LIST.length} text="Submit" href="/submit" />
              </div>
              {/* Logout */}
              <div
                onClick={() => {
              ...
              >
                <NavItem active={activeIdx === MENU_LIST.length + 1} text="Logout" href="/logout" />
              </div>
            </>
          )}
          {!user && (
            ...
            >
              <NavItem active={activeIdx === MENU_LIST.length} text="Login" href="/login" />
            </div>
          )}
        </div>
      </nav>
